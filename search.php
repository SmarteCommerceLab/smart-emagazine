...
<main class="container site-main overflow-hidden">
    ...
    <div class="row mb-5">
        <?php if (have_posts()) : while (have_posts()) : the_post();if($post->post_type == 'post' or $post->post_type == 'page'):?>
    ...
    <div class="px-4 mb-1"><?php if(is_plugin_active('smart-bootstrap-manager/smart-bootstrap-manager.php')){if(function_exists("wp_bs_pagination")){wp_bs_pagination();}}?></div>
</main>
