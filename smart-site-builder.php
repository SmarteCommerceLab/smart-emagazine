<?php
/*
* Template name: Smart Site Builder
*/
?>
...
<main class="container site-main">
    ...
    <?php
        ...
        // -- sem-page-'.get_queried_object()->ID.'-compose-control-setting
		if(get_queried_object()){if(get_queried_object()->ID){
		if($option = sem_option_check('sem-page-'.get_queried_object()->ID.'-compose-control-setting')){
