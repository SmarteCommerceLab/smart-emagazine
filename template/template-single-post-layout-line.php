...
<main id="main" class="container site-main layout-line overflow-hidden border-start border-end bg-white">
	<article id="post-<?php echo $post->ID;?>">
        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-4 mb-4">
            	<div class="d-flex flex-column flex-md-row flex-xl-column justify-content-md-between align-items-start align-items-xl-start align-items-stretch border-only-md-top border-only-lg-top border-only-md-bottom border-only-lg-bottom py-md-2 py-xl-0">
                    <?php get_template_part('template-parts/single-author-meta', null, array('class' => 'd-flex justify-content-start align-items-center small border-only-xs-top pt-4 pt-md-0')); ?>
        ...
        <article id="post-<?php echo $post->ID;?>-article">
			...
			<?php get_template_part('template-parts/single-featured-image', null, array('figure_class' => 'figure text-center d-table mx-auto', 'image_class' => 'img-fluid figure-img skip-lazy mb-3- my-0', 'caption_class' => 'figure-caption text-start text-muted text-lowercase small')); ?>
