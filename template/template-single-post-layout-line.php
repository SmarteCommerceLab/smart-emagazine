...
?>
<main id="main" class="container site-main layout-line overflow-hidden border-start border-end bg-white">
	<article id="post-<?php echo $post->ID;?>">
        ...
        <div class="row">
        	<header class="col-12 col-xl-8 border-lg-end mb-4">
            	<hgroup>
					<?php the_title('<h1 class="entry-title mb-3">','</h1>');?>
                    <?php the_sub_title('<h2 class="text-start small fw-normal text-muted mb-3">','</h2>');?>
                </hgroup>
            </header>
            <div class="col-12 col-xl-4 mb-4">
            	<div class="d-flex flex-column flex-md-row flex-xl-column justify-content-md-between align-items-start align-items-xl-start align-items-stretch border-only-md-top border-only-lg-top border-only-md-bottom border-only-lg-bottom py-md-2 py-xl-0">
                    <div class="d-flex justify-content-start align-items-center small border-only-xs-top pt-4 pt-md-0">
                    ...
                    <div class="text-muted my-4 border-only-xs-top border-only-xs-bottom py-4 py-md-0">
                        <a 
                        class	= "link link-social link-social-facebook text-center text-muted p-2 me-2 border" 
                        ...
                        <a 
                        class	= "link link-social link-social-twitter text-center text-muted p-2 me-2 border"
                        ...
                        <a 
                        class	= "link link-social link-social-whatsapp text-center text-muted p-2 me-2 border"
                        ...
                        <a 
                        class	= "link link-social link-social-linkedin text-center text-muted p-2 me-2 border"
			...
			<?php if (has_post_thumbnail()){?>
                <figure class="figure text-center d-table mx-auto">
                    <?php the_post_thumbnail('large',array(
                        'decoding'		=> "async",
                        'fetchpriority'	=> "high",
                        'class'			=> "img-fluid figure-img skip-lazy mb-3- my-0",
                        'alt'			=> get_the_title(),
                        'title'			=> get_the_title()
                    ));?>
