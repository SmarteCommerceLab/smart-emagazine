...
<main class="container site-main overflow-hidden">
    ...
    <hr>                  
    <?php if($paged == 0){
		$category_primary_post = new semComposeWidget(get_queried_object()->slug,get_queried_object()->slug,'post_tag','open',NULL,NULL,NULL);
		$e = $category_primary_post->esclude_post;
	}?>
    <?php if($paged == 0){?><p>Tutte le notizie di <span class="h4 text-primary"><strong><?php echo get_queried_object()->name; ?></strong></span></p><hr><?php }?>
    <div class="row">
